                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a class="btn btn-success" href="<?php echo base_url("assets/dokumen/") . $dokumen ?>">Lihat Berkas <?= $nama ?></a></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </table>
                                ...
                                <!-- /.card-body -->
                                <a href="<?= base_url(); ?>Lapor/view_admin" class="btn btn-warning"><i class="fas">Kembali</i></a>
                            </div>
                            <!-- /.card -->
                        </div>
                        <!-- /.col -->
