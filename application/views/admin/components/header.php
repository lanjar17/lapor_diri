...
<title>Admin PPG UNISSULA</title>
<link rel="icon" type="image/x-icon" href="<?php echo base_url("assets/logo-ppg.png") ?>">

<!--===============================================================================================-->
<link rel="icon" type="image/png" href="<?= base_url(); ?>assets/unisula.png" />
