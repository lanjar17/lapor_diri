                                                    ...
                                                    <div class="table-responsive">
                                                        <div class="table table-striped table-hover ">
                                                            <a href="" class="btn btn-primary" data-toggle="modal"
                                                                data-target="#edit_data_mahasiswa<?=$id_user?>">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?php echo base_url()?>Mahasiswa/hapus_mahasiswa"
                                            ...
                                            <div class="modal fade" id="edit_data_mahasiswa<?=$id_user?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="<?=base_url();?>Mahasiswa/edit_mahasiswa"
                                                                method="POST">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?=base_url();?>Mahasiswa/tambah_mahasiswa" method="POST">
                                ...
                                <div class="form-group">
                                    <label for="email">Email SIMPKB</label>
