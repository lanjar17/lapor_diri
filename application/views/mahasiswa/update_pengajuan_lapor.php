                        ...
                        ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md col-12">
                                    ...
                                    <select name="jenis_kelamin" id="jenis_kelamin" class="form-control editable" aria-describedby="jenis_kelamin" value="<?= $jenis_kelamin ?>" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md col-12">
                                    ...
                                    <input class="form-control editable" type="number" name="ptk_id" id="ptk_id" aria-describedby="ptk_id" value="<?= $ptk_id ?>" disabled required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md col-12">
                                    ...
                                    <input class="form-control editable" type="number" name="no_peserta" id="no_peserta" placeholder="masukkan nomor peserta" aria-describedby="no_peserta" value="<?= $no_peserta ?>" disabled required>
                                </div>
                                <div class="col-md col-12">
                                    <label for="" class="labels text-gray-800">NIM</label>
                                    <input class="form-control editable" type="text" name="nim" id="nim" placeholder="masukkan NIM" aria-describedby="nim" value="<?= $nim ?>" disabled required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 col-12">
                                    ...
                                    <input class="form-control editable" type="text" name="lptk" id="lptk" placeholder="masukkan LPTK" aria-describedby="lptk" value="<?= $lptk ?>" disabled required>
                                </div>
                                <div class="col-md-6 col-12">
                                    <label for="" class="labels text-gray-800">BIDANG STUDI PPG</label>
                                    <select name="bidang_studi" id="bidang_studi" class="form-control editable" aria-describedby="bidang_studi" value="<?= $bidang_studi ?>" disabled required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 col-12">
                                    ...
                                    <textarea class="form-control editable" type="text" name="alamat" id="alamat" placeholder="masukkan alamat" aria-describedby="alamat" value="<?= $alamat ?>" required></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4 col-12">
                                    ...
                                    <select name="provinsi" id="provinsi" class="form-control editable" aria-describedby="provinsi" value="<?= $provinsi ?>" required>
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <select name="kabupaten" id="kabupaten" class="form-control editable" aria-describedby="kabupaten" value="<?= $kabupaten ?>" required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md col-12">
                                    ...
                                    <input class="form-control editable" type="text" name="nama_rekening" id="nama_rekening" placeholder="masukkan nama sesuai rekening" aria-describedby="nama_rekening" value="<?= $nama_rekening ?>" required>
                                </div>
                                <div class="col-md col-12">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4 col-12">
                                    ...
                                    <input class="form-control editable" type="text" name="nama_bank" id="nama_bank" placeholder="" aria-describedby="nama_bank" value="<?= $nama_bank ?>" required>
                                </div>
                                <div class="col-md-4 col-12">
                                    <label for="" class="labels text-gray-800">BANK CABANG</label>
                                    <input class="form-control editable" type="text" name="bank_cabang" id="bank_cabang" placeholder="" aria-describedby="bank_cabang" value="<?= $bank_cabang ?>" required>
                                </div>
                                <div class="col-md-4 col-12">
                                    <label for="" class="labels text-gray-800">NO REKENING</label>
                                    <input class="form-control editable" type="number" name="no_rekening" id="no_rekening" placeholder="" aria-describedby="no_rekening" value="<?= $no_rekening ?>" required>
                                </div>
