                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Data Lapor Mahasiswa</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-responsive">
                                                            <div class="table table-striped table-hover ">
                                                                <a href="" class="btn btn-primary" data-toggle="modal" data-target="#setuju<?= $id_mahasiswa ?>">
                                                                ...
                                                                <!-- <div class="table-responsive">
                                                            <div class="table table-striped table-hover "> -->
                                                                <a href="" data-toggle="modal" data-target="#tidak_setuju<?= $id_mahasiswa ?>" class="btn btn-danger"><i class="fas fa-times"></i>
                                                                </a>
                                                                <!-- </div>
                                                        </div> -->
                                                                <!-- <div class="table-responsive">
                                                            <div class="table table-striped table-hover "> -->
                                                                <a href="<?= base_url("Lapor/detail_superadmin/") . $id_mahasiswa; ?>" class="btn btn-success"><i class="fas fa-search-plus"></i></a>
                                                            </div>
                                                        </div>
                                                ...
                                                <!-- Modal Setuju Cuti -->
                                                <div class="modal fade" id="setuju<?= $id_mahasiswa ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="<?php echo base_url() ?>Lapor/acc_lapor_super_admin/2" method="post" enctype="multipart/form-data">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <input type="hidden" name="id_mahasiswa" value="<?php echo $id_mahasiswa ?>" />
                                                                            <input type="hidden" name="id_user" value="<?php echo $id_user ?>" />
                                                                            <p>Apakah kamu yakin ingin Menyetujui Izin Lapor
                                                                                ini?</i></b></p>
                                                ...
                                                <div class="modal fade" id="tidak_setuju<?= $id_mahasiswa ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="<?php echo base_url() ?>Lapor/acc_lapor_super_admin/3" method="post" enctype="multipart/form-data">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <input type="hidden" name="id_mahasiswa" value="<?php echo $id_mahasiswa ?>" />
                                                                            <input type="hidden" name="id_user" value="<?php echo $id_user ?>" />

                                                                            <p>Apakah kamu yakin ingin Menolak Izin Lapor
                                                                                ini?</i></b></p>
                                                                            <div class="form-group">
                                                                                <label for="exampleFormControlTextarea1">Alasan</label>
                                                                                <textarea class="form-control" id="alasan_verifikasi" name="alasan_verifikasi" rows="3"></textarea>
