                                ...
                                <div class="card-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                action="<?php echo base_url()?>Mahasiswa/super_admin_hapus_mahasiswa"
                                            ...
                                            <!-- Modal Edit Pegawai -->
                                            <div class="modal fade" id="edit_data_mahasiswa<?=$id_user?>" tabindex="-1"
                                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                action="<?=base_url();?>Mahasiswa/super_admin_edit_mahasiswa"
                                                                method="POST">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?=base_url();?>Mahasiswa/super_admin_tMahasiswa" method="POST">
                                <div class="form-group">
                                    <label for="username">Username</label>
